    ...
    <>
      ...
      <div className="padding add-social-page">
        <p className="description-p">
          To add a social network, please complete the following information.
          The best display mode for social networks is up to 5 items.
        </p>
          ...
          <div className="form-field">
            ...
            <div className="form-input">
              <input
                ...
                type="text"
                value={link}
                placeholder="Write the link here without spaces"
              />
