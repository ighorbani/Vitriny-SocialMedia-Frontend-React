  ...
  const [presentations, setPresentation] = useState([
    {
      ...
      selected: true,
      title: "Display with Features and Prices",
    },
    {
        ...
        >
          ...
          <div className="form-input">
            <input
              ...
              name="tags"
              type="text"
              placeholder="e.g. #kebab #delicious_kebab #kebabi"
              value={tags}
            />
            <div className="input-check"></div>
          </div>
          ...
          <div
            ...
            style={{ paddingRight: "2rem", paddingLeft: "2rem" }}
          >
            <div className="input-label">Product Description</div>
            <div className="form-input">
              <textarea
